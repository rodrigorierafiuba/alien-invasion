...
class Scoreboard:
    ...
    def __init__(self, ai_game):
        ...
        self.text_color = (COLOR_X, COLOR_Y, COLOR_Z)
    ...
    def update_score(self, collision):
        """Update's score if collision happen."""
        if collision:
    ...
    def update_level(self):
        """Increase the level of the game if there are not aliens in the canvas."""
        self.stats.level += 1

    def show_score(self):
        # blit(object, position)
